...
<span id="i13052904"  class ="c13110505"  >
     ...
     <div class="c14111903" id ="Div6">
            <input id="Text1" type="text"  runat ="server" class="c14111902" visible="false" /></div>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
     ...
     '<%#Eval ("CWAREID") %>','<%#Eval ("CNAME") %>','<%#Eval ("SELLUNITPRICE") %>','<%#Eval ("SPEC") %>','<%#Eval ("REMARK") %>'
             ...
             '<%#Eval ("MaxStorageCount") %>', '<%#Eval ("PURCHASEUNITPRICE") %>','<%#Eval ("PLANK_THICKNESS") %>')">
                       选取</a>
                   </ItemTemplate>
                ...
                <ItemTemplate >
                 ...
                 <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                  ...
                  <asp:BoundField DataField="CWAREID" HeaderText="客户料号" >
                             ...
                             <asp:BoundField DataField="security_stock" HeaderText="安全库存" >
                              <ItemStyle Width="110px" ForeColor="#595d5a" />
...
<script type="text/javascript" language="javascript">
    var arr1 = new Array();
    var arr2 = new Array();
    function f13100302(obj, obj1, obj2, obj3, obj4, obj5, obj6, obj7, obj8,obj9,obj10,obj11,obj12,obj13,obj14,obj15) {
